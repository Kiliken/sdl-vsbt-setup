...
SET includes=/I src /I %cd%/SDL3-3.xVersioNx/include
SET links=/link /LIBPATH:%cd%/src /LIBPATH:%cd%/SDL3-3.xVersioNx/lib/x64 MSVCRT.lib LIBCMT.lib opengl32.lib User32.lib Shell32.lib Gdi32.lib Kernel32.lib Advapi32.lib Ole32.lib Oleaut32.lib uuid.lib odbc32.lib odbccp32.lib SDL3.lib
